    ...
    <div className="space-y-14">
      ...
      <section className="grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="space-y-5">
          <p className="text-lg leading-relaxed text-muted">
            Brawl Stars gives you seconds to pick. Switching apps to check a tier list costs more
            of them than you have — so this puts the list on top of the game instead, one tap
            away, and gets out of the way when you are done.
          </p>
          ...
          <details className="card p-4">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted">
              You should be careful about installing apps from websites. This one is signed with a
              key we hold, and you can confirm the file you got is the file we published:
            </p>
      ...
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          <article className="card p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted">
              S through D, scored on adjusted win rate and pick rate from sampled competitive
              battles. The same numbers as the site, refreshed on the same schedule.
            </p>
          </article>
          ...
          <article className="card p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted">
              Switching apps mid-draft risks the timer and can drop you back into a lobby. The
              overlay draws on top instead, so the game keeps running underneath.
            </p>
          </article>
          ...
          <article className="card p-5">
            ...
            <p className="mt-2 text-sm leading-relaxed text-muted">
              The current rotation is listed under the tier list, so you can see which maps the
              names above are being ranked against.
            </p>
          </article>
        </div>
        ...
        */}
        <div className="card border-border-strong p-5">
          ...
          <p className="mt-2 text-sm leading-relaxed text-muted">
            The bubble cannot see your screen, your match, or which map you are on — Android does
            not let one app read another&apos;s display, and nothing that claims otherwise is doing
            it legitimately. It shows the meta and the live rotation; you match that to the draft
            in front of you. It does not touch the game, read your account, or send anything
            anywhere.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <p className="text-sm leading-relaxed text-muted">
          Google Play Protect may warn you about any app installed outside the Play Store. That
          warning is about where the file came from, not about what is in it — which is what the
          checksum above is for.
        </p>
      </section>
      ...
      <section className="space-y-4">
        <SectionHeading title="Using it" subtitle="Three gestures, and that is the whole app." />
      ...
      <section className="card card-glow p-6 sm:p-8">
        ...
        <p className="mt-2 max-w-2xl leading-relaxed text-muted">
          Everything the bubble shows is on the site, with far more behind it — per-map picks, team
          comps, matchups and your own profile. The app exists only to save you the app switch.
        </p>
